...
def generate_sky(height, width):
    ...
    n_stars = 10000  # create 5000 "stars" to start with
    ...
    #sky = ndimage.filters.gaussian_filter(sky, 0.9, mode='nearest')
    #sky = ndimage.median_filter(sky, 1, mode='nearest')  # kernel window of 9
...
if __name__ == '__main__':
    ...
    fig.savefig('./graphics/background.png', dpi = 1300)
